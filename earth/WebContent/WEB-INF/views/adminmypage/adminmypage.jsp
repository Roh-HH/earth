        ...
        <div class="row" style="width:1000px;">
            ...
            <%-- 작성자/내용 검색 --%>
            	<div class="text-align:right;">
					<form style="float:right;height:60px;" class="woocommerce-ordering" method="get" action="/earth/adminmypage/adminUserForm.et" >
                ...
                <div class="single-post">
                    ...
                    <div class="blog_details" style="width:650px;">
                        <c:if test="${count == 0}">
				        ...
				        <c:if test="${count != 0}">
				            <table align="center">
				            <th align="center"><%--체크박스용--%></th>
				            <th align="center">ID</th>
				            <th align="center">닉네임</th> 
				            <th align="center">이메일</th>
				            <th align="center">경고</th>
				            <th align="center">신고</th>
				       
				      		<c:forEach var="user" items="${UserList}" varStatus="status">
								<tr align="center">
									<td><input type="checkbox" name="${status.count}" value="${ID}"/>
									<td>${user.id}</td>
									<td>${user.nickname}</td>
									<td>${user.email}</td>
							...
							<br /> 
							<c:if test="${sel != null && search != null}">
								<button onclick="window.location='/earth/adminmypage/adminUserForm.et?'">초기화</button> <br />
							</c:if>
                    </div>
                </div>
			</div>
