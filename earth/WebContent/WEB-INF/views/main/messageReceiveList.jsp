												...
												<c:if test="${count > 0}">
													...
													<c:if test="${sel != null && search != null}">
														<c:if test="${startPage > pageBlock}">
															<a href="/earth/main/messageReceiveList.et?pageNum=${startPage-pageBlock}&sel=${sel}&search=${search}#anc" class="pageNums">Back</a>
														</c:if>
														<c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
															<a href="/earth/main/messageReceiveList.et?pageNum=${i}&sel=${sel}&search=${search}#anc" class="pageNums">${i}</a>
														</c:forEach>
														<c:if test="${endPage < pageCount}">
															<a href="/earth/main/messageReceiveList.et?pageNum=${startPage+pageBlock}&sel=${sel}&search=${search}#anc" class="pageNums">Next</a>
														</c:if>
													</c:if>
													...
													<c:if test="${sel == null || search == null}">
														<c:if test="${startPage > pageBlock}">
															<a href="/earth/main/messageReceiveList.et?pageNum=${startPage-pageBlock}#anc" class="pageNums">Back</a>
														</c:if>
														<c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
															<a href="/earth/main/messageReceiveList.et?pageNum=${i}#anc" class="pageNums">${i}</a>
														</c:forEach>
														<c:if test="${endPage < pageCount}">
															<a href="/earth/main/messageReceiveList.et?pageNum=${startPage+pageBlock}#anc" class="pageNums">Next</a>
														</c:if>
													</c:if>
												</c:if> <%-- end:count > 0 --%>
											</nav>
